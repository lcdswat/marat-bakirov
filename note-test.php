...
<a href="/" class="back-to-notes">&larr;&nbsp;Все заметки</a>
...
<p>Наши пронумерованные входные билеты в цирк готовы. Давайте перейдем к примеру посложнее.</p>
<p>Предположим, в нашем воображаемом цирке работает 10 человек, и всем им периодически нужно печатать визитки. Чтобы ускорить процесс их подготовки и в будущем вносить правки быстрее, мы подготовили два файла — шаблон в индизайне и данные в экселе.</p>
...
<p>Почти как кнопка «Сверстать», да?</p>
