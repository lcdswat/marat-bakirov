...
<!-- EOF Меню -->
	...
	<div class="item-container">
		...
		<div id="item-wrapper">
			...
			<div id="left">
				<a href="pilot" class="arrow-left">PILOT</a>
				<span>TERON</span>
				<img src="site-files/4.jpg">
				<img src="site-files/4-icons.png">
			</div>
			<div id="right">
				<a href="nextrino" class="arrow-right">NEXTRINO</a>
				<b>Габаритные размеры:</b>
				<img src="site-files/4-schema.png">
				<br>
				<br>
				<br>
				<br>
				...
				BL-3015.ON<br>
				Крепится на пластиковые винты<br>
				к внешней стороне рассеивателя.<br>
				Дополнительные аксессуары не предусмотрены.
...
<div id="item-ttx">
	...
	<table cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
			<td class="a">a15594</td>
			<td>BS-TERON-71-S1-INEXI2</td>
			<td>постоянный</td>
			<td>INEXI-2M</td>
			<td>100 000</td>
			<td>1</td>
		...
		<tr>
			<td class="a">a15595</td>
			<td>BS-TERON-73-S1-INEXI2</td>
			<td>постоянный</td>
			<td>INEXI-2M</td>
			<td>100 000</td>
			<td>3</td>
		...
		<tr>
			...
			<!-- Остальные модели -->
			<style type="text/css">#item-teron {display: none;}</style>
