...
<!-- EOF Меню -->
	...
	<div class="item-container">
		...
		<div id="item-wrapper">
			...
			<div id="left">
				<a href="junior" class="arrow-left">JUNIOR</a>
				<span>KONTUR</span>
				<br><br><br><br><br><br><img src="site-files/kontur.png"><br><br><br><br><br><br><br>
				<div class="icons">
					<img src="site-files/icons/led.svg" id="led">
					<img src="site-files/icons/ip44.svg" id="ip44">
			...
			<div id="right">
				<a href="meteor" class="arrow-right">METEOR</a>
				<b>Габаритные размеры:</b>
				<img src="site-files/kontur-schema-1.png"><br>
				<b>Знак безопасности:</b><br>
				BL-3015B.ON<br>
				Крепится на двухсторонний скотч внутри рассеивателя.<br>
				<br>
				<b>Толщина светильника:</b><br><br>
				<img src="site-files/kontur-schema-2.png"><br>
				<b>Аксессуары:</b><br><br>
				<img src="site-files/kontur-schema-3.png">
				<div class="fleft descriptor" style="width: 148px; margin: 20px 65px 0 0;"><b>a16175</b><br>Решетка защитная BS-R-2</div>
				<div class="fleft descriptor" style="width: 148px; margin: 20px 0 0 0;"><b>a14565</b><br>Комплект аксессуаров<br>BS-KA-3 для крепления в&nbsp;гипсокартон</div>
			</div>
			<div class="clean"></div>
...
<div id="item-ttx">
	...
	<table cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
			<td class="a">a15743</td>
			<td> BS-KONTUR-71-S1-INEXI2</td>
			<td>постоянный</td>
			<td>INEXI-2M</td>
			<td>100 000</td>
			<td>1</td>
		...
		<tr>
			<td class="a">a15744</td>
			<td> BS-KONTUR-73-S1-INEXI2</td>
			<td>постоянный</td>
			<td>INEXI-2M</td>
			<td>100 000</td>
			<td>3</td>
		...
		<tr>
			<td class="a">a15741</td>
			<td> BS-KONTUR-81-S1-INEXI2</td>
			<td>непостоянный</td>
			<td>INEXI-2N</td>
			<td>50 000</td>
			<td>1</td>
		...
		<tr>
			<td class="a">a15742</td>
			<td> BS-KONTUR-83-S1-INEXI2</td>
			<td>непостоянный</td>
			<td>INEXI-2N</td>
			<td>50 000</td>
			<td>3</td>
			...
			<!-- Остальные модели -->
			<style type="text/css">#item-KONTUR {display: none;}</style>
