...
<!-- EOF Меню -->
	...
	<div class="item-container">
		...
		<div id="item-wrapper">
			...
			<div id="left">
				<a href="mitra" class="arrow-left">MITRA</a>
				<span>POLET</span>
				<br><br><br><br><br><br><br><br><br><br><br><br><br><br><img src="site-files/mitra.png"><br><br><br><br><br><br><br><br><br><br><br><br><br>
				<div class="icons">
					<img src="site-files/icons/led.svg" id="led">
					<img src="site-files/icons/ip20.svg" id="ip20">
					<img src="site-files/icons/romb-30.svg" id="romb-30">
					<img src="site-files/icons/zazemle.svg" id="zazemle">
					<img src="site-files/icons/pktalu.svg" id="pktalu">
					<img src="site-files/icons/gray9006.svg" id="gray9006">
			...
			<div id="right">
				<a href="sputnik" class="arrow-right">SPUTNIK</a>
				<b>Габаритные размеры:</b><br><br>
				<img src="site-files/polet-schema-1.png"><br><br>
				<b>Знак безопасности:</b><br>
				BL-3015A.ON<br>
				Крепится на плаcтиковые винты к внешней стороне рассеивателя.<br><br>
				<br>
				<b>Аксессуары:</b><br><br>
				<img src="site-files/polet-schema-2.png">
				<div class="fleft descriptor" style="width: 135px; margin: 20px 65px 0 0;"><b>а333</b><br>Кронштейн BS-K-2</div>
				<div class="fleft descriptor" style="width: 135px; margin: 20px 65px 0 0;"><b>а331</b><br>Штанга BS-SH-1-30</div>
				<div class="fleft descriptor" style="width: 135px; margin: 20px 0 0 0;"><b>а418</b><br>Штанга BS-SH-1-300<br><b>а419</b><br>Штанга BS-SH-1-500<br><b>а664</b><br>Штанга BS-SH-1-1000<br></div>
			</div>
			<div class="clean"></div>
...
<div id="item-ttx">
	...
	<table cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
			<td class="a">a15985</td>
			<td> BS-POLET-71-S1-INEXI2</td>
			<td>постоянный</td>
			<td>INEXI-2M</td>
			<td>100 000</td>
			<td>1</td>
		...
		<tr>
			<td class="a">a15986</td>
			<td> BS-POLET-73-S1-INEXI2</td>
			<td>постоянный</td>
			<td>INEXI-2M</td>
			<td>100 000</td>
			<td>3</td>
			...
			<!-- Остальные модели -->
			<style type="text/css">#item-POLET {display: none;}</style>
